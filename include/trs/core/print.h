...
/// @ingroup core
/// @brief trs_FPrint — how a container is told to show one elem
///
...
/// identity, so long long is served by trs_fprint_i64, while char, size and ptrdiff have
...
/// address.
typedef void (*trs_FPrint)(FILE *, const void *);
...
/// @bigo{1}
TRS_API
void trs_fprint_i8(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_i16(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_i32(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_i64(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_u8(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_u16(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_u32(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_u64(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_size(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_ptrdiff(FILE *stream, const void *val);
...
/// @bigo{1}
TRS_API
void trs_fprint_f32(FILE *stream, const void *val);

/// a double through %g, as trs_fprint_f32
/// @param stream where to write
/// @param val the address of the elem
/// @bigo{1}
TRS_API
void trs_fprint_f64(FILE *stream, const void *val);

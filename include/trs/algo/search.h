...
/// span sorted by the same cmp — so trs_span_binary_search is the only search here. The
...
/// trs_span_find without the index
/// @param s the span
/// @param key the address of the value
/// @param eq the equality
/// @return whether it is there
...
/// the boundary of a span partitioned by 'pred' — trs_span_lower_bound generalized

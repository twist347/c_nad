...
///
/// trs_Al has four operations and no alignment to pass, so alignment is a property of the
...
/// @warning it frees nothing it handed out — every block goes back through trs_dealloc
///          first, as with trs_al_default
/// @bigo{1}
TRS_API

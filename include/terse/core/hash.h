...
/// @ingroup core
/// @brief trs_Hasher, and ready-made hashers for the built-in types
///
/// A hasher takes one value by address and returns a trs_Hash. It travels paired with a
/// trs_Eq, under one law: what the equality calls equal must hash alike.
///
...
///
/// trs_hash_bytes and trs_hash_combine are the two that are not trs_Hasher, and what a
...
typedef uint64_t trs_Hash;

/// Hashes the value at its operand. Named for the agent rather than the operation,
/// because trs_Hash is already the name of the result.
typedef trs_Hash (*trs_Hasher)(const void *);
...
/// @bigo{1}
[[nodiscard]] TRS_API
trs_Hash trs_hash_i8(const void *val);

/// a int16_t
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_i16(const void *val);

/// a int32_t
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_i32(const void *val);

/// a int64_t
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_i64(const void *val);
...
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_u8(const void *val);

/// a uint16_t
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_u16(const void *val);

/// a uint32_t
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_u32(const void *val);

/// a uint64_t
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_u64(const void *val);
...
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_size(const void *val);
...
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_ptrdiff(const void *val);
...
/// a float, canonicalized so the hash agrees with trs_eq_f32
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_f32(const void *val);

/// a double, as trs_hash_f32
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
...
/// @copydetails trs_hash_i8
[[nodiscard]] TRS_API
trs_Hash trs_hash_char(const void *val);
...
/// 'len' bytes at 'data' — not a trs_Hasher, since it takes a length
/// @param data the bytes; may be null only when 'len' is 0
/// @param len how many bytes to read
/// @return their hash
/// @warning bytes agree with memcmp, not with trs_eq_<T>: padding is read, -0.0 and +0.0

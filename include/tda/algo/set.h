...
/// by the same cmp, so they compose with each other and with tda_span_merge.
///
...
///
/// Run the spans through tda_span_unique first for plain set behaviour instead.
///
/// Each writes into 'dst' and returns how much was filled, as tda_span_copy_if does: a

...
///
/// tda_Al has four operations and no alignment to pass, so alignment is a property of the
...
/// @warning it frees nothing it handed out — every block goes back through tda_dealloc
///          first, as with tda_al_default
/// @bigo{1}
TDA_API

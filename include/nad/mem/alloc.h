...
[[nodiscard]] NAD_API void *nad_alloc(nad_Allocator *al, size_t size);
...
[[nodiscard]] NAD_API void *nad_calloc(nad_Allocator *al, size_t num, size_t size);
...
[[nodiscard]] NAD_API void *nad_realloc(nad_Allocator *al, void *ptr, size_t old_size, size_t new_size);

// Frees ptr; no-op if ptr is nullptr. size must match the original allocation.
NAD_API void nad_dealloc(nad_Allocator *al, void *ptr, size_t size);

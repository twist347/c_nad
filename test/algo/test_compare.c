...
static bool eq_abs_i32(const void *a, const void *b) {
    ...
    return trs_eq_i32(&ax, &ay);
}

// a comparator returning the raw difference, not -1/0/+1: trs_span_cmp
...
static void test_eq_same_contents() {
    ...
    TEST_ASSERT_TRUE(trs_span_eq(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3)));
}
...
static void test_eq_differs_in_the_last_elem() {
    ...
    TEST_ASSERT_FALSE(trs_span_eq(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3)));
}
...
static void test_eq_different_lengths() {
    ...
    TEST_ASSERT_FALSE(trs_span_eq(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, a, 2)));
}
...
static void test_eq_empty_spans_are_equal() {
    ...
    TEST_ASSERT_TRUE(trs_span_eq(TRS_SPAN_FROM_DATA(int32_t, a, 0), TRS_SPAN_FROM_DATA(int32_t, b, 0)));
}

// two null empty views must compare equal without dereferencing anything
static void test_eq_null_views_are_equal() {
    TEST_ASSERT_TRUE(trs_span_eq(TRS_SPAN_FROM_DATA(int32_t, nullptr, 0), TRS_SPAN_FROM_DATA(int32_t, nullptr, 0)));
}

static void test_eq_same_buffer_is_equal() {
    constexpr int32_t a[3] = {1, 2, 3};
    const trs_Span s = TRS_SPAN_FROM_DATA(int32_t, a, 3);

    TEST_ASSERT_TRUE(trs_span_eq(s, s));
}
...
static void test_eq_compares_whole_elements() {
    ...
    TEST_ASSERT_FALSE(trs_span_eq(TRS_SPAN_FROM_DATA(Pair, x, 2), TRS_SPAN_FROM_DATA(Pair, y, 2)));
}
...
static void test_eq_by_uses_the_predicate() {
    ...
    TEST_ASSERT_FALSE(trs_span_eq(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3)));
    TEST_ASSERT_TRUE(trs_span_eq_by(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3), eq_abs_i32));
}

static void test_eq_by_different_lengths() {
    constexpr int32_t a[3] = {1, 2, 3};

    TEST_ASSERT_FALSE(trs_span_eq_by(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, a, 2), trs_eq_i32));
}
...
static void test_eq_by_same_buffer_skips_the_predicate() {
    ...
    eq_calls = 0;
    TEST_ASSERT_TRUE(trs_span_eq_by(s, s, eq_counting_i32));
...
static void test_eq_by_stops_at_the_first_mismatch() {
    ...
    eq_calls = 0;
    TEST_ASSERT_FALSE(
        trs_span_eq_by(TRS_SPAN_FROM_DATA(int32_t, a, 4), TRS_SPAN_FROM_DATA(int32_t, b, 4), eq_counting_i32)
    );
...
static void test_eq_by_empty_spans_are_equal() {
    ...
    eq_calls = 0;
    TEST_ASSERT_TRUE(
        trs_span_eq_by(TRS_SPAN_FROM_DATA(int32_t, a, 0), TRS_SPAN_FROM_DATA(int32_t, a, 0), eq_counting_i32)
    );
    TEST_ASSERT_EQUAL_size_t(0, eq_calls);
}
...
static void test_mismatch_reports_the_first_disagreement() {
    ...
    size_t idx = 999;
    TEST_ASSERT_TRUE(
        trs_span_mismatch(TRS_SPAN_FROM_DATA(int32_t, a, 4), TRS_SPAN_FROM_DATA(int32_t, b, 4), trs_eq_i32, &idx)
    );
...
static void test_mismatch_at_the_very_first_elem() {
    ...
    size_t idx = 999;
    TEST_ASSERT_TRUE(
        trs_span_mismatch(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3), trs_eq_i32, &idx)
    );
...
static void test_mismatch_looks_at_the_common_prefix_only() {
    ...
    TEST_ASSERT_FALSE(
        trs_span_mismatch(
            TRS_SPAN_FROM_DATA(int32_t, shorter, 2),
            TRS_SPAN_FROM_DATA(int32_t, longer, 4),
            trs_eq_i32,
            &idx
        )
    );
...
static void test_mismatch_of_empty_spans_finds_nothing() {
    ...
    TEST_ASSERT_FALSE(
        trs_span_mismatch(
            ...
            TRS_SPAN_FROM_DATA(int32_t, buf, 2),
            trs_eq_i32,
            &idx
        )
    );
...
static void test_mismatch_honours_the_callback() {
    ...
    TEST_ASSERT_TRUE(
        trs_span_mismatch(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3), eq_abs_i32, &idx)
    );
    TEST_ASSERT_EQUAL_size_t(2, idx);
}
...
static void test_cmp_of_equal_spans_is_zero() {
    ...
    TEST_ASSERT_EQUAL_INT(
        0,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, a, 3), TRS_SPAN_FROM_DATA(int32_t, b, 3), trs_cmp_i32)
    );
}
...
static void test_cmp_is_decided_by_the_first_difference() {
    ...
    TEST_ASSERT_EQUAL_INT(
        1,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, b, 3), TRS_SPAN_FROM_DATA(int32_t, a, 3), trs_cmp_i32)
    );
}
...
static void test_cmp_orders_a_prefix_before_the_longer_span() {
    ...
    TEST_ASSERT_EQUAL_INT(
        -1,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, shorter, 2), TRS_SPAN_FROM_DATA(int32_t, longer, 3), trs_cmp_i32)
    );
    TEST_ASSERT_EQUAL_INT(
        1,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, longer, 3), TRS_SPAN_FROM_DATA(int32_t, shorter, 2), trs_cmp_i32)
    );
}
...
static void test_cmp_of_empty_spans() {
    ...
    TEST_ASSERT_EQUAL_INT(0, trs_span_cmp(empty, empty, trs_cmp_i32));
    TEST_ASSERT_EQUAL_INT(-1, trs_span_cmp(empty, TRS_SPAN_FROM_DATA(int32_t, buf, 1), trs_cmp_i32));
    TEST_ASSERT_EQUAL_INT(1, trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, buf, 1), empty, trs_cmp_i32));
}
...
static void test_cmp_normalizes_whatever_the_callback_returns() {
    ...
    TEST_ASSERT_EQUAL_INT(
        -1,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, a, 2), TRS_SPAN_FROM_DATA(int32_t, b, 2), cmp_diff_i32)
    );
    TEST_ASSERT_EQUAL_INT(
        1,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, b, 2), TRS_SPAN_FROM_DATA(int32_t, a, 2), cmp_diff_i32)
    );
}
...
static void test_cmp_follows_the_comparator() {
    ...
    TEST_ASSERT_EQUAL_INT(
        1,
        trs_span_cmp(TRS_SPAN_FROM_DATA(int32_t, a, 2), TRS_SPAN_FROM_DATA(int32_t, b, 2), trs_cmp_desc_i32)
    );
}
...
static void test_cmp_and_eq_agree() {
    ...
    const trs_Span sa = TRS_SPAN_FROM_DATA(int32_t, a, 3);
    const trs_Span sb = TRS_SPAN_FROM_DATA(int32_t, b, 3);
    const trs_Span sc = TRS_SPAN_FROM_DATA(int32_t, c, 3);

    TEST_ASSERT_TRUE(trs_span_eq(sa, sb) == (trs_span_cmp(sa, sb, trs_cmp_i32) == 0));
    TEST_ASSERT_TRUE(trs_span_eq(sa, sc) == (trs_span_cmp(sa, sc, trs_cmp_i32) == 0));
}

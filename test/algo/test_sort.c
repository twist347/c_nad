...
static void test_insertion_sort_orders_a_shuffled_span() {
    ...
    trs_span_insertion_sort(s, trs_cmp_i32);
...
static void test_insertion_sort_empty_and_single_are_noop() {
    ...
    trs_span_insertion_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 0), trs_cmp_i32);
    TEST_ASSERT_EQUAL_INT32(42, buf[0]);

    trs_span_insertion_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 1), trs_cmp_i32);
    TEST_ASSERT_EQUAL_INT32(42, buf[0]);
}
...
static void test_insertion_sort_follows_the_comparator() {
    ...
    trs_span_insertion_sort(s, trs_cmp_desc_i32);
...
static void test_insertion_sort_is_stable() {
    ...
    const trs_SpanMut s = TRS_SPAN_FROM_DATA_MUT(Tagged, buf, 5);

    trs_span_insertion_sort(s, cmp_tagged);
...
static void test_insertion_sort_stays_within_the_subspan() {
    ...
    trs_span_insertion_sort(trs_span_sub_mut(s, 1, 3), trs_cmp_i32);
...
static void test_sort_orders_a_shuffled_span() {
    ...
    trs_span_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 6), trs_cmp_i32);
...
static void test_sort_empty_and_single_are_noop() {
    ...
    trs_span_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 0), trs_cmp_i32);
    TEST_ASSERT_EQUAL_INT32(42, buf[0]);

    trs_span_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 1), trs_cmp_i32);
    TEST_ASSERT_EQUAL_INT32(42, buf[0]);
}
...
static void test_sort_follows_the_comparator() {
    ...
    trs_span_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 5), trs_cmp_desc_i32);
...
static void test_sort_stays_within_the_subspan() {
    ...
    trs_span_sort(trs_span_sub_mut(s, 1, 3), trs_cmp_i32);
...
static void test_sort_orders_a_long_span() {
    ...
    const trs_SpanMut s = TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 64);
    TEST_ASSERT_FALSE(trs_span_is_sorted(trs_span_mut_to_span(s), trs_cmp_i32));
...
static void test_sort_moves_whole_elems() {
    ...
    trs_span_sort(TRS_SPAN_FROM_DATA_MUT(Tagged, buf, 3), cmp_tagged);
...
static void test_sort_stable_orders_a_shuffled_span() {
    ...
    TEST_ASSERT_EQUAL_INT(
        TRS_STATUS_OK,
        trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 6), trs_cmp_i32, trs_al_default())
    );
...
static void test_sort_stable_keeps_equal_elems_in_order() {
    ...
    TEST_ASSERT_EQUAL_INT(
        TRS_STATUS_OK,
        trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(Tagged, buf, 6), cmp_tagged, trs_al_default())
    );
...
static void test_sort_stable_handles_lengths_that_are_not_powers_of_two() {
    for (size_t len = 1; len <= 11; ++len) {
        ...
        TEST_ASSERT_EQUAL_INT(
            TRS_STATUS_OK,
            trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, len), trs_cmp_i32, trs_al_default())
        );
...
static void test_sort_stable_stays_within_the_subspan() {
    ...
    TEST_ASSERT_EQUAL_INT(
        TRS_STATUS_OK,
        trs_span_sort_stable(trs_span_sub_mut(s, 1, 3), trs_cmp_i32, trs_al_default())
    );
...
static void test_sort_stable_works_through_an_arena() {
    ...
    TEST_ASSERT_EQUAL_INT(
        TRS_STATUS_OK,
        trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 5), trs_cmp_i32, arena)
    );
...
static void test_sort_stable_reports_an_exhausted_arena() {
    trs_Al *arena = trs_al_arena_new(trs_al_default(), 16);
    TEST_ASSERT_NOT_NULL(arena);
    ...
    TEST_ASSERT_EQUAL_INT(
        ...
        trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 8), trs_cmp_i32, arena)
    );
...
static void test_sort_stable_of_empty_and_single_needs_no_scratch() {
    ...
    TEST_ASSERT_EQUAL_INT(
        TRS_STATUS_OK,
        trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 0), trs_cmp_i32, arena)
    );
    TEST_ASSERT_EQUAL_INT(
        TRS_STATUS_OK,
        trs_span_sort_stable(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 1), trs_cmp_i32, arena)
    );
...
static void test_partial_sort_puts_the_n_smallest_in_order_at_the_front() {
    ...
    trs_span_partial_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 8), 3, trs_cmp_i32);
...
static void test_partial_sort_with_n_zero_is_a_noop() {
    ...
    trs_span_partial_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 4), 0, trs_cmp_i32);
...
static void test_partial_sort_with_n_equal_to_len_sorts_everything() {
    ...
    trs_span_partial_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 5), 5, trs_cmp_i32);
...
static void test_partial_sort_follows_the_comparator() {
    ...
    trs_span_partial_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 6), 2, trs_cmp_desc_i32);
...
static void test_partial_sort_handles_duplicates() {
    ...
    trs_span_partial_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 7), 4, trs_cmp_i32);
...
static void test_nth_elem_places_every_position() {
    ...
    for (size_t nth = 0; nth < 7; ++nth) {
        ...
        trs_span_nth_elem(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 7), nth, trs_cmp_i32);
...
static void test_nth_elem_partitions_around_the_nth() {
    ...
    trs_span_nth_elem(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 9), nth, trs_cmp_i32);
...
static void test_nth_elem_of_a_single_is_a_noop() {
    ...
    trs_span_nth_elem(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 1), 0, trs_cmp_i32);
...
static void test_nth_elem_handles_duplicates() {
    ...
    for (size_t nth = 0; nth < 8; ++nth) {
        ...
        trs_span_nth_elem(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, 8), nth, trs_cmp_i32);
...
static void test_nth_elem_stays_within_the_subspan() {
    ...
    trs_span_nth_elem(trs_span_sub_mut(s, 1, 4), 0, trs_cmp_i32);
...
static void test_sort_stays_n_log_n_on_ordered_input() {
    ...
    cmp_calls = 0;
    trs_span_sort(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, SCALE_N), cmp_i32_counting);
...
static void test_nth_elem_stays_linear() {
    ...
    cmp_calls = 0;
    trs_span_nth_elem(TRS_SPAN_FROM_DATA_MUT(int32_t, buf, SCALE_N), SCALE_N / 2, cmp_i32_counting);
    TEST_ASSERT_LESS_THAN_size_t(8 * SCALE_N, cmp_calls);
...
static void test_is_sorted_accepts_ascending() {
    ...
    TEST_ASSERT_TRUE(trs_span_is_sorted(TRS_SPAN_FROM_DATA(int32_t, buf, 4), trs_cmp_i32));
}
...
static void test_is_sorted_rejects_a_late_inversion() {
    ...
    TEST_ASSERT_FALSE(trs_span_is_sorted(TRS_SPAN_FROM_DATA(int32_t, buf, 4), trs_cmp_i32));
}

static void test_is_sorted_empty_and_single_are_sorted() {
    constexpr int32_t buf[1] = {42};

    TEST_ASSERT_TRUE(trs_span_is_sorted(TRS_SPAN_FROM_DATA(int32_t, buf, 0), trs_cmp_i32));
    TEST_ASSERT_TRUE(trs_span_is_sorted(TRS_SPAN_FROM_DATA(int32_t, buf, 1), trs_cmp_i32));
}
...
static void test_is_sorted_until_points_at_the_first_break() {
    ...
    TEST_ASSERT_EQUAL_size_t(3, trs_span_is_sorted_until(TRS_SPAN_FROM_DATA(int32_t, buf, 6), trs_cmp_i32));
}
...
static void test_is_sorted_until_of_a_sorted_span_is_its_length() {
    ...
    TEST_ASSERT_EQUAL_size_t(4, trs_span_is_sorted_until(s, trs_cmp_i32));
    TEST_ASSERT_TRUE(trs_span_is_sorted(s, trs_cmp_i32));
}
...
static void test_is_sorted_until_on_short_and_flat_spans() {
    ...
    TEST_ASSERT_EQUAL_size_t(0, trs_span_is_sorted_until(TRS_SPAN_FROM_DATA(int32_t, nullptr, 0), trs_cmp_i32));
    TEST_ASSERT_EQUAL_size_t(1, trs_span_is_sorted_until(TRS_SPAN_FROM_DATA(int32_t, one, 1), trs_cmp_i32));
    TEST_ASSERT_EQUAL_size_t(3, trs_span_is_sorted_until(TRS_SPAN_FROM_DATA(int32_t, flat, 3), trs_cmp_i32));
}

static void test_is_sorted_until_breaks_at_the_second_elem() {
    constexpr int32_t buf[3] = {9, 1, 2};

    TEST_ASSERT_EQUAL_size_t(1, trs_span_is_sorted_until(TRS_SPAN_FROM_DATA(int32_t, buf, 3), trs_cmp_i32));
}

static void test_is_sorted_until_follows_the_comparator() {
    constexpr int32_t buf[4] = {4, 3, 2, 9};

    TEST_ASSERT_EQUAL_size_t(3, trs_span_is_sorted_until(TRS_SPAN_FROM_DATA(int32_t, buf, 4), trs_cmp_desc_i32));
}
